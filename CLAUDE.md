...
Element Tracker desktop app — a port of the original Element Tracker Chrome extension to **Electron + Playwright**. Captures interactive web elements and generates resilient XPath/CSS selectors. Cross-platform (Windows/macOS/Linux), cross-browser (Chromium/Firefox/WebKit via Playwright).
